...
<header id="event_container" class="wrapper">
	<div class="container content">
		...
		<ul class="pagination justify-content-center content">
			<li class="page-item">
				<a class="page-link" href="?orientation=<?php echo $orientation?>&
											page=1&
			...
			<li class="page-item">
				<a class="page-link" href="?orientation=<?php echo $orientation?>&page=1&limit=12">1</a>
			</li>
			<?php if ($data['orientation'] == 'outdoor'): ?>
				<li class="page-item">
					<a class="page-link" href="?orientation=<?php echo $orientation?>&page=2&limit=12">2</a>
				</li>
			<? endif ?>
			<li class="page-item">
				<a class="page-link" href="?orientation=<?php echo $orientation?>&
